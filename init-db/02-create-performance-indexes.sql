...
CREATE INDEX IF NOT EXISTS idx_patient_clinic_active ON patients(clinic_id, is_active);
CREATE INDEX IF NOT EXISTS idx_patient_phone ON patients(clinic_id, phone);
CREATE INDEX IF NOT EXISTS idx_patient_first_name ON patients(clinic_id, first_name);
CREATE INDEX IF NOT EXISTS idx_patient_last_name ON patients(clinic_id, last_name);
CREATE INDEX IF NOT EXISTS idx_patient_created_at ON patients(clinic_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_patient_tag_patients ON patient_tag(clinic_id, patient_id);
...
-- Follow-up Indexes
CREATE INDEX IF NOT EXISTS idx_followup_patients
...
-- Invoice Indexes
CREATE INDEX IF NOT EXISTS idx_invoice_patients
...
CREATE INDEX IF NOT EXISTS idx_visit_patients
